    ...
    <main className=" bg-white">
      <div className="pt-24 pb-20 max-w-4xl mx-auto">
        <section className="text-slate-800 mb-6">
          ...
          <p className="font-medium text-lg mb-6 font-rethink-sans">
            MENTIONS LÉGALES
          </p>
        ...
        <section className="mb-8 text-slate-800">
          <h2 className="text-xl font-bold mb-4 font-rethink-sans">
            1. Informations légales
          </h2>

          <div className="space-y-2">
            <p>
              <span className="font-medium">Propriétaire :</span> Arnaud Graciet
            </p>
            <p>
        ...
        <section className="mb-8 text-slate-800">
          ...
          <p className="text-justify">
            Arnaud Graciet est propriétaire unique de tous les droits de
            propriété intellectuelle ou détient les droits et autorisations
            d'usage sur tous les éléments accessibles sur le site, tant sur la
            structure que sur les articles et textes, graphismes, logo, sons,
            logiciels, etc…
          </p>
          <p className="text-justify mt-2">
