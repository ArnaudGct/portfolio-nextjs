...
export default function OutilItem({
  id,
  title,
  tags,
  miniature,
        ...
        >
          ...
          {isInView && (
            <>
              ...
              <div className="absolute inset-0 bg-black/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center p-4 md:p-6 rounded-lg z-20">
                <p className="text-white text-sm md:text-base text-center line-clamp-4 font-rethink-sans leading-relaxed">
                  {description?.split('\n')[0]}
                </p>
              </div>
            </>
