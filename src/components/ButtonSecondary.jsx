...
export default function ButtonSecondary({
  ...
  const classes = `group flex flex-row items-center gap-2 bg-blue-50 text-blue-700 rounded-lg hover:bg-blue-100 transition duration-300 border border-transparent dark:border-blue-200 ${paddingClass} ${sizeClass} ${className} ${
