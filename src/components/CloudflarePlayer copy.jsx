    ...
    <div className="relative w-full h-full overflow-hidden">
      ...
      <div className="absolute bottom-4 left-4 z-10 flex flex-row items-center gap-4">
        <div className="flex items-center gap-2">
          <button
            onClick={togglePlay}
            className="text-slate-300 p-2 bg-black/30 rounded-full hover:bg-black/50 transition-colors"
          ...
          <span className="text-slate-300 text-sm font-normal font-rethink-sans">
